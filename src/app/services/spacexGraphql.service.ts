...
export type ShipsDetailsQuery = (
  { __typename?: 'Query' }
  & { ship?: Maybe<(
    { __typename?: 'Ship' }
    & Pick<Ship, 'name' | 'year_built' | 'weight_kg' | 'home_port' | 'type'>
...
export class ShipsDetailsGQL extends Apollo.Query<ShipsDetailsQuery> {
  document = ShipsDetailsDocument;
...
export class ShipsListGQL extends Apollo.Query<ShipsListQuery> {
  document = ShipsListDocument;
